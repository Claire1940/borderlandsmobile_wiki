...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Borderlands Mobile Wiki',
    description: 'Borderlands Mobile Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our mobile game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Borderlands Mobile Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Borderlands Mobile Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Borderlands Mobile Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with 2K Games or Gearbox Software. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@borderlandsmobile.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@borderlandsmobile.wiki</a>
            </p>
            <p>
