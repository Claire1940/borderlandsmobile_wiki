...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Borderlands Mobile Wiki',
    description: 'Copyright and intellectual property information for Borderlands Mobile Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Borderlands Mobile Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Borderlands Mobile Wiki',
      description: 'Copyright and intellectual property information for Borderlands Mobile Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Borderlands Mobile Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Borderlands Mobile Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Borderlands Mobile Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              
              <li><strong>Borderlands Mobile Developers</strong> - Creators of the Borderlands Mobile game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>BORDERLANDS</strong> - Trademark of 2K Games / Gearbox Software</li>
              <li><strong>Borderlands Mobile</strong> - Trademark of the game developers</li>
              <li><strong>Borderlands Mobile Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Borderlands Mobile Wiki.
            </p>
            ...
            <p>
              ...
              Borderlands Mobile Wiki<br />
              Email: <a href="mailto:dmca@borderlandsmobile.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@borderlandsmobile.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Borderlands Mobile Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Borderlands Mobile Wiki (borderlandsmobile.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@borderlandsmobile.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@borderlandsmobile.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@borderlandsmobile.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@borderlandsmobile.wiki</a>
            </p>
            <p>
